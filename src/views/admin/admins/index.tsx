...
const Admins = (): JSX.Element => {
  ...
  const api = React.useMemo(() => {
    ...
    console.log('Admins API Selection:', { pathname: location.pathname, isDemo, api: isDemo ? 'demoApi' : 'apiReal' });
  ...
  React.useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      const fetchData = async () => {
        try {
          const res = await (api as any).listAdmins({});
          if (!mounted || abortController.signal.aborted) return;
              ...
              <tr
                ...
                onClick={async () => {
                  try {
                    ...
                    const fullAdmin = await (api as any).getAdmin(row.id);
